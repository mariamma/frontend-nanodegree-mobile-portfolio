...
var adjectives="dark color whimsical shiny noisy apocalyptic insulting praise scientific".split(" "),nouns="animals everyday fantasy gross horror jewelry places scifi".split(" ");function generator(a,b){a=getAdj(a);b=getNoun(b);var c=parseInt(Math.random()*a.length),d=parseInt(Math.random()*b.length);return"The "+a[c].capitalize()+" "+b[d].capitalize()}
...
function(){return pizzaIngredients.crusts[Math.floor(Math.random()*pizzaIngredients.crusts.length)]},ingredientItemizer=function(a){return"\x3cli\x3e"+a+"\x3c/li\x3e"},makeRandomPizza=function(){for(var a="",b=Math.floor(4*Math.random()),c=Math.floor(3*Math.random()),d=Math.floor(2*Math.random()),e=0;e<b;e++)a+=ingredientItemizer(selectRandomMeat());for(b=0;b<c;b++)a+=ingredientItemizer(selectRandomNonMeat());for(c=0;c<d;c++)a+=ingredientItemizer(selectRandomCheese());a+=ingredientItemizer(selectRandomSauce());
return a+=ingredientItemizer(selectRandomCrust())},pizzaElementGenerator=function(a){var b=document.createElement("div");var c=document.createElement("div");var d=document.createElement("img");var e=document.createElement("div");b.classList.add("randomPizzaContainer");b.style.width="33.33%";b.style.height="325px";b.id="pizza"+a;c.style.width="35%";d.src="images/pizza.png";d.classList.add("img-responsive");c.appendChild(d);b.appendChild(c);e.style.width="65%";a=document.createElement("h4");a.innerHTML=
randomName();e.appendChild(a);a=document.createElement("ul");a.innerHTML=makeRandomPizza();e.appendChild(a);b.appendChild(e);return b},resizePizzas=function(a){window.performance.mark("mark_start_resize");a:switch(a){case "1":document.querySelector("#pizzaSize").innerHTML="Small";break a;case "2":document.querySelector("#pizzaSize").innerHTML="Medium";break a;case "3":document.querySelector("#pizzaSize").innerHTML="Large";break a;default:console.log("bug in changeSliderLabel")}for(var b=document.getElementsByClassName("randomPizzaContainer"),
c=0;c<b.length;c++){var d=a;var e=b[c].offsetWidth,f=document.querySelector("#randomPizzas").offsetWidth;e/=f;a:{switch(d){case "1":d=.25;break a;case "2":d=.3333;break a;case "3":d=.5;break a;default:console.log("bug in sizeSwitcher")}d=void 0}b[c].style.width=b[c].offsetWidth+(d-e)*f+"px"}window.performance.mark("mark_end_resize");window.performance.measure("measure_pizza_resize","mark_start_resize","mark_end_resize");a=window.performance.getEntriesByName("measure_pizza_resize");console.log("Time to resize pizzas: "+
a[a.length-1].duration+"ms")};window.performance.mark("mark_start_generating");pizzasDiv=document.getElementById("randomPizzas");for(var i=2;100>i;i++)pizzasDiv.appendChild(pizzaElementGenerator(i));window.performance.mark("mark_end_generating");window.performance.measure("measure_pizza_generation","mark_start_generating","mark_end_generating");var timeToGenerate=window.performance.getEntriesByName("measure_pizza_generation");
console.log("Time to generate pizzas on load: "+timeToGenerate[0].duration+"ms");var frame=0;function logAverageFrame(a){for(var b=a.length,c=0,d=b-1;d>b-11;d--)c+=a[d].duration;console.log("Average scripting time to generate last 10 frames: "+c/10+"ms")}
function updatePositions(){frame++;window.performance.mark("mark_start_frame");for(var a=document.querySelectorAll(".mover"),b=document.body.scrollTop/1250,c=0;c<a.length;c++)a[c].style.left=a[c].basicLeft+100*Math.sin(b+c%5)+"px";window.performance.mark("mark_end_frame");window.performance.measure("measure_frame_duration","mark_start_frame","mark_end_frame");0===frame%10&&(a=window.performance.getEntriesByName("measure_frame_duration"),logAverageFrame(a))}window.addEventListener("scroll",updatePositions);
document.addEventListener("DOMContentLoaded",function(){var a=width.screen.height/256*8;console.log("Pizza count "+a);for(var b=0;b<a;b++){var c=document.createElement("img");c.className="mover";c.src="images/pizza.png";c.style.height="100px";c.style.width="73.333px";c.basicLeft=b%8*256;c.style.top=256*Math.floor(b/8)+"px";document.querySelector("#movingPizzas1").appendChild(c)}updatePositions()});
...
case "everyday":return"mirror knife fork spork spoon tupperware minivan suburb lamp desk stereo television TV book car truck soda door video game computer calender tree plant flower chimney attic kitchen garden school wallet bottle".split(" ");case "jewelry":return"earrings ring necklace pendant choker brooch bracelet cameo charm bauble trinket jewelry anklet bangle locket finery crown tiara blingBling chain rosary jewel gemstone beads armband pin costume ornament treasure".split(" ");case "places":return"swamp graveyard cemetery park building house river ocean sea field forest woods neighborhood city town suburb country meadow cliffs lake stream creek school college university library bakery shop store theater garden canyon highway restaurant cafe diner street road freeway alley".split(" ");
case "scifi":return"robot alien raygun spaceship UFO rocket phaser astronaut spaceman planet star galaxy computer future timeMachine wormHole timeTraveler scientist invention martian pluto jupiter saturn mars quasar blackHole warpDrive laser orbit gears molecule electron neutrino proton experiment photon apparatus universe gravity darkMatter constellation circuit asteroid".split(" ");default:return"robot alien raygun spaceship UFO rocket phaser astronaut spaceman planet star galaxy computer future timeMachine wormHole timeTraveler scientist invention martian pluto jupiter saturn mars quasar blackHole warpDrive laser orbit gears molecule electron neutrino proton experiment photon apparatus universe gravity darkMatter constellation circuit asteroid".split(" ")}}
adjectives="dark color whimsical shiny noisy apocalyptic insulting praise scientific".split(" ");nouns="animals everyday fantasy gross horror jewelry places scifi".split(" ");function generator(a,b){a=getAdj(a);b=getNoun(b);var c=parseInt(Math.random()*a.length),d=parseInt(Math.random()*b.length);return"The "+a[c].capitalize()+" "+b[d].capitalize()}
function randomName(){var a=parseInt(Math.random()*adjectives.length),b=parseInt(Math.random()*nouns.length);return generator(adjectives[a],nouns[b])}selectRandomMeat=function(){return pizzaIngredients.meats[Math.floor(Math.random()*pizzaIngredients.meats.length)]};selectRandomNonMeat=function(){return pizzaIngredients.nonMeats[Math.floor(Math.random()*pizzaIngredients.nonMeats.length)]};selectRandomCheese=function(){return pizzaIngredients.cheeses[Math.floor(Math.random()*pizzaIngredients.cheeses.length)]};
selectRandomSauce=function(){return pizzaIngredients.sauces[Math.floor(Math.random()*pizzaIngredients.sauces.length)]};selectRandomCrust=function(){return pizzaIngredients.crusts[Math.floor(Math.random()*pizzaIngredients.crusts.length)]};ingredientItemizer=function(a){return"\x3cli\x3e"+a+"\x3c/li\x3e"};
makeRandomPizza=function(){for(var a="",b=Math.floor(4*Math.random()),c=Math.floor(3*Math.random()),d=Math.floor(2*Math.random()),e=0;e<b;e++)a+=ingredientItemizer(selectRandomMeat());for(b=0;b<c;b++)a+=ingredientItemizer(selectRandomNonMeat());for(c=0;c<d;c++)a+=ingredientItemizer(selectRandomCheese());a+=ingredientItemizer(selectRandomSauce());return a+ingredientItemizer(selectRandomCrust())};
pizzaElementGenerator=function(a){var b=document.createElement("div"),c=document.createElement("div"),d=document.createElement("img"),e=document.createElement("div");b.classList.add("randomPizzaContainer");b.style.width="33.33%";b.style.height="325px";b.id="pizza"+a;c.style.width="35%";d.src="images/pizza.png";d.classList.add("img-responsive");c.appendChild(d);b.appendChild(c);e.style.width="65%";a=document.createElement("h4");a.innerHTML=randomName();e.appendChild(a);a=document.createElement("ul");
a.innerHTML=makeRandomPizza();e.appendChild(a);b.appendChild(e);return b};
resizePizzas=function(a){window.performance.mark("mark_start_resize");a:switch(a){case "1":document.querySelector("#pizzaSize").innerHTML="Small";break a;case "2":document.querySelector("#pizzaSize").innerHTML="Medium";break a;case "3":document.querySelector("#pizzaSize").innerHTML="Large";break a;default:console.log("bug in changeSliderLabel")}for(var b=0;b<document.querySelectorAll(".randomPizzaContainer").length;b++){var c=document.querySelectorAll(".randomPizzaContainer")[b],d=a,e=c.offsetWidth;
c=document.querySelector("#randomPizzas").offsetWidth;e/=c;a:{switch(d){case "1":d=.25;break a;case "2":d=.3333;break a;case "3":d=.5;break a;default:console.log("bug in sizeSwitcher")}d=void 0}d=(d-e)*c;d=document.querySelectorAll(".randomPizzaContainer")[b].offsetWidth+d+"px";document.querySelectorAll(".randomPizzaContainer")[b].style.width=d}window.performance.mark("mark_end_resize");window.performance.measure("measure_pizza_resize","mark_start_resize","mark_end_resize");a=window.performance.getEntriesByName("measure_pizza_resize");
console.log("Time to resize pizzas: "+a[a.length-1].duration+"ms")};window.performance.mark("mark_start_generating");for(i=2;100>i;i++)pizzasDiv=document.getElementById("randomPizzas"),pizzasDiv.appendChild(pizzaElementGenerator(i));window.performance.mark("mark_end_generating");window.performance.measure("measure_pizza_generation","mark_start_generating","mark_end_generating");timeToGenerate=window.performance.getEntriesByName("measure_pizza_generation");
console.log("Time to generate pizzas on load: "+timeToGenerate[0].duration+"ms");frame=0;function logAverageFrame(a){for(var b=a.length,c=0,d=b-1;d>b-11;d--)c+=a[d].duration;console.log("Average scripting time to generate last 10 frames: "+c/10+"ms")}
